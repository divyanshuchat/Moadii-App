...
export class ConferenceApp {
  ...
  loggedInPages: PageInterface[] = [
    { title: 'View Profile', name: 'AccountPage', component: AccountPage, icon: 'person' },
    { title: 'Edit Profile', name: 'SupportPage', component: SupportPage, icon: 'help' },
    { title: 'Moadii Offers & publications', name: 'SupportPage', component: SupportPage, icon: 'help' },
